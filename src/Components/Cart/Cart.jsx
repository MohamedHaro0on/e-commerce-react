                  ...
                  <div className="card-body p-0">
                    <div className="row g-0">
                        ...
                        <div className="p-5">
                          ...
                          {cartDetails.data.products.map((product) => (
                            <div className="row mb-4 d-flex justify-content-between align-items-center container">
                              ...
                              <div
                                className={`${styles["margin-top-sm"]} col-md-3 col-lg-3 col-xl-3`}
                              >
                      ...
                      <div className="col-lg-4 bg-body-tertiary">
                        <div className="p-5">
                          <h3 className="fw-semibold text-sec mb-4 mt-1 ">
                            Summary
                          </h3>
                          <hr className="my-4" />
                          ...
                          <h5 className="text-uppercase h6 text-sec mb-3">
                            Shipping
                          </h5>
                          ...
                          <div className="mb-4 pb-2">
                            ...
                            >
                              <option value="1" className="bg-main py-3">
                                Free shipping
                              </option>
                            </select>
                          </div>

                          <h5 className="text-uppercase mb-3 h6 text-sec">
                            Promo code
                          </h5>
                          ...
                          <div className="d-flex justify-content-between mb-5">
                            <h5 className="text-uppercase h6 text-sec">
                              Total price
                            </h5>
                            <h5 className="h6 text-main">
                              <span>{cartDetails.data.totalCartPrice} EGP</span>
